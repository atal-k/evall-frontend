...
import './FinanceOwnershipPage.css';
...
// ============================================================================
const FinanceOwnershipPage = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

  return (
    <div className="finance-ownership-page">
      {/* Hero Section */}
      <section className="finance-hero">
        <div className="finance-hero-content">
          <h1 className="finance-hero-title">Own Your EVall. Drive Smarter. Pay Your Way.</h1>
          ...
          <div className="finance-hero-ctas">
            <a href="/contact/customer-support" className="finance-btn finance-btn-primary">
            ...
            <a href="/resources/tco-calculator" className="finance-btn finance-btn-secondary">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
      ...
      <section className="finance-benefits">
        <div className="finance-container">
          <div className="finance-section-header">
            <h2 className="finance-section-title">Simple, Transparent, and Business-Oriented Financing</h2>
          ...
          <div className="finance-benefits-grid">
            <div className="finance-benefit-card">
              <div className="finance-benefit-icon">
              ...
              <h3 className="finance-benefit-title">Flexible Down Payments</h3>
              <p className="finance-benefit-description">
            ...
            <div className="finance-benefit-card">
              ...
              <h3 className="finance-benefit-title">Fast Documentation</h3>
              <p className="finance-benefit-description">
            ...
            <div className="finance-benefit-card">
              ...
              <h3 className="finance-benefit-title">Transparent Pricing</h3>
              <p className="finance-benefit-description">
            ...
            <div className="finance-benefit-card">
              ...
              <h3 className="finance-benefit-title">Trusted Partners</h3>
              <p className="finance-benefit-description">
      ...
      <section className="finance-ownership-models">
        <div className="finance-container">
          <div className="finance-section-header">
            <h2 className="finance-section-title">Choose the Ownership Model That Works for Your Business</h2>
            <p className="finance-section-subtitle">
      ...
      {/* Finance Options */}
      <section className="finance-options">
        <div className="finance-container">
          <div className="finance-options-content">
            <div className="finance-options-text">
              <h2 className="finance-section-title">Finance Options That Work for You</h2>
              <p className="finance-options-description">
              ...
              <ul className="finance-options-list">
                <li>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2m-1.41 16.09L6 13.5l1.41-1.41l3.18 3.18l6.89-6.89l1.41 1.41z" />
                  </svg>
              ...
              <a href="/contact" className="finance-btn finance-btn-primary">
                Talk to a Finance Advisor
              </a>
            </div>
            <div className="finance-options-visual">
              <img src="/images/finance-ownership/finance-partners.webp" alt="Finance partners ecosystem" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* TCO Advantage */}
      <section className="finance-tco">
        <div className="finance-container">
          <div className="finance-section-header">
            <h2 className="finance-section-title">The Total Cost of Ownership Advantage</h2>
            <p className="finance-section-subtitle">
          ...
          <div className="finance-tco-comparison">
            <div className="finance-tco-card finance-tco-card--diesel">
              <div className="finance-tco-header">
              ...
              <div className="finance-tco-metrics">
                <div className="finance-tco-metric">
                  <span className="finance-tco-label">Fuel Cost</span>
                  <span className="finance-tco-value finance-tco-value--high">High</span>
                </div>
                <div className="finance-tco-metric">
                  <span className="finance-tco-label">Maintenance</span>
                  <span className="finance-tco-value finance-tco-value--high">Frequent</span>
                </div>
                <div className="finance-tco-metric">
                  <span className="finance-tco-label">Downtime</span>
                  <span className="finance-tco-value finance-tco-value--high">Higher</span>
                </div>
                <div className="finance-tco-metric">
                  <span className="finance-tco-label">Operating Cost</span>
                  <span className="finance-tco-value finance-tco-value--high">₹12-15/km</span>
                </div>
              </div>
            </div>

            <div className="finance-tco-vs">
              <span>VS</span>
            </div>

            <div className="finance-tco-card finance-tco-card--ev">
              <div className="finance-tco-header">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
              ...
              <div className="finance-tco-metrics">
                <div className="finance-tco-metric">
                  <span className="finance-tco-label">Charging Cost</span>
                  <span className="finance-tco-value finance-tco-value--low">70% Lower</span>
                </div>
                <div className="finance-tco-metric">
                  <span className="finance-tco-label">Maintenance</span>
                  <span className="finance-tco-value finance-tco-value--low">Minimal</span>
                </div>
                <div className="finance-tco-metric">
                  <span className="finance-tco-label">Downtime</span>
                  <span className="finance-tco-value finance-tco-value--low">Lower</span>
                </div>
                <div className="finance-tco-metric">
                  <span className="finance-tco-label">Operating Cost</span>
                  <span className="finance-tco-value finance-tco-value--low">₹3-4/km</span>
                </div>
              </div>
            </div>
          </div>

          <div className="finance-tco-savings">
            <h3 className="finance-tco-savings-title">Key Factors in Savings</h3>
            <div className="finance-tco-savings-grid">
              <div className="finance-tco-saving-item">
            ...
            <div className="finance-tco-cta">
              <a href="/resources/tco-calculator" className="finance-btn finance-btn-primary">
                Use TCO Calculator
              </a>
            </div>
          </div>
      ...
      {/* Eligibility Section */}
      <section className="finance-eligibility">
        <div className="finance-container">
          <div className="finance-section-header">
            <h2 className="finance-section-title">Eligibility and Documentation</h2>
            <p className="finance-section-subtitle">
              Minimal documentation required for faster vehicle delivery. We support you every step of the way.
            </p>
          </div>

          <div className="finance-eligibility-grid">
            <div className="finance-eligibility-card">
              <div className="finance-eligibility-icon">
              ...
              <h3 className="finance-eligibility-title">For Businesses</h3>
              <ul className="finance-eligibility-list">
                <li>
            ...
            <div className="finance-eligibility-card">
              ...
              <h3 className="finance-eligibility-title">For Individuals</h3>
              <ul className="finance-eligibility-list">
                <li>
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M9 16.17L4.83 12l-1.42 1.41L9 19L21 7l-1.41-1.41z" />
      ...
      <section className="finance-support">
        <div className="finance-container">
          <div className="finance-section-header">
            <h2 className="finance-section-title">Complete Ownership Experience from Day One</h2>
            <p className="finance-section-subtitle">
          ...
          <div className="finance-support-grid">
            <div className="finance-support-card">
              <div className="finance-support-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24">
                  <path fill="currentColor" d="M12 15.5A3.5 3.5 0 0 1 8.5 12A3.5 3.5 0 0 1 12 8.5a3.5 3.5 0 0 1 3.5 3.5a3.5 3.5 0 0 1-3.5 3.5m7.43-2.53c.04-.32.07-.64.07-.97s-.03-.66-.07-1l2.11-1.63c.19-.15.24-.42.12-.64l-2-3.46c-.12-.22-.39-.31-.61-.22l-2.49 1c-.52-.39-1.06-.73-1.69-.98l-.37-2.65A.506.506 0 0 0 14 2h-4c-.25 0-.46.18-.5.42l-.37 2.65c-.63.25-1.17.59-1.69.98l-2.49-1c-.22-.09-.49 0-.61.22l-2 3.46c-.13.22-.07.49.12.64L4.57 11c-.04.34-.07.67-.07 1s.03.65.07.97l-2.11 1.66c-.19.15-.25.42-.12.64l2 3.46c.12.22.39.3.61.22l2.49-1.01c.52.4 1.06.74 1.69.99l.37 2.65c.04.24.25.42.5.42h4c.25 0 .46-.18.5-.42l.37-2.65c.63-.26 1.17-.59 1.69-.99l2.49 1.01c.22.08.49 0 .61-.22l2-3.46c.12-.22.07-.49-.12-.64z" />
                </svg>
              </div>
              <h3 className="finance-support-title">Scheduled Service</h3>
              <p className="finance-support-description">Regular maintenance and assistance to keep your fleet running smoothly.</p>
            </div>
            ...
            <div className="finance-support-card">
              ...
              <h3 className="finance-support-title">Charging Partnerships</h3>
              <p className="finance-support-description">On-route and depot charging solutions for seamless operations.</p>
            </div>
            ...
            <div className="finance-support-card">
              ...
              <h3 className="finance-support-title">Dealer Network</h3>
              <p className="finance-support-description">Expanding service centers across regions for convenient access.</p>
            </div>
            ...
            <div className="finance-support-card">
              ...
              <h3 className="finance-support-title">Warranty Support</h3>
              <p className="finance-support-description">Comprehensive coverage for vehicle and battery systems.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* FAQ Section */}
      <section className="finance-faq">
        <div className="finance-container">
          <div className="finance-section-header">
            <h2 className="finance-section-title">Frequently Asked Questions</h2>
            <p className="finance-section-subtitle">
      ...
      {/* Final CTA Section */}
      <section className="finance-final-cta">
        <div className="finance-container">
          <div className="finance-final-cta-card">
            <div className="finance-final-cta-icon">
            ...
            <h2 className="finance-final-cta-title">Ready to Move Your Business Forward?</h2>
            <p className="finance-final-cta-description">
            ...
            <a href="/contact/customer-support" className="finance-btn finance-btn-large">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
export default FinanceOwnershipPage;