...
const leadershipData = {
    ...
    persons: [
        ...
        about:
            "Ajit Kumar leads sourcing strategy, vendor development, and operations excellence. With vast experience in supply-chain management, he drives cost optimization and supplier partnerships to strengthen Evall Mobility’s growing electric vehicle portfolio.",
        img: {
            src: "/images/leadership/ajit-kumar.webp",
            alt: "Ajit Kumar - Vice President, Strategic Sourcing & Operations",
        },
        links: {
            linkedin: "#",
            facebook: "#",
        ...
        {
          name: "Satyendra Pal",
          position: "DGM – Sales & Marketing",
          about:
            "A seasoned professional in the Electric Commercial Vehicle (e-CV) segment, Satyendra Pal drives business development, strategic sales, and customer engagement. He leverages OEM partnerships to deliver tailored fleet solutions that accelerate EV adoption.",
          img: {
            src: "/images/leadership/satyendra-pal.webp",
            alt: "Satyendra Pal - DGM – Sales & Marketing, Evall Mobility Ltd."
          },
          links: {
            linkedin: "#",
            facebook: "#",
