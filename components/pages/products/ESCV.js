...
const ESCVPageComponent = () => {
  ...
  // Exterior Features Data - UPDATED with responsive positions
const exteriorFeaturesData = {
  ...
  image: "/images/exterior-features/main.jpg",
...
// Interior Features Data - UPDATED with responsive positions
const interiorFeaturesData = {
  ...
  image: "/images/interior-features/main.jpg",
  ...
  features: [
    {
      ...
      position: {
        desktop: { top: "37.6%", right: "39.4%" },
        tablet: { top: "37.6%", right: "39.4%" },
        mobile: { top: "35%", right: "33%" },
        small: { top: "35%", right: "33%" } 
      }
    },
    {
      id: 2,
      ...
      position: {
        desktop: { top: "48.3%", right: "22.2%" },
        tablet: { top: "48.3%", right: "22.2%" }, 
        mobile: { top: "44%", right: "15%" },
        small: { top: "44%", right: "15%" } 
      }
    },
    {
      id: 3,
