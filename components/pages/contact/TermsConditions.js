        ...
        <div className={styles['legal-page']}>
          <div className={styles['legal-hero']}>
            <div className={styles['legal-hero-content']}>
              <h1 className={styles['legal-title']}>Terms and Conditions</h1>
              <p className={styles['legal-subtitle']}>Please read these terms carefully before using our services.</p>
          ...
          <div className={styles['legal-container']}>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>1. Acceptance of Terms</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>2. Company Information</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>3. Use of Website</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>4. Intellectual Property Rights</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>5. Product Information</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>6. Pricing and Offers</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>7. Third-Party Links</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>8. Limitation of Liability</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>9. Warranty and Service</h2>
              ...
              <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>10. Privacy and Data Protection</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>11. Indemnification</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>12. Governing Law and Jurisdiction</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>13. Modifications to Terms</h2>
              ...
              <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>14. Contact Information</h2>
