// ============================================
// components/pages/contact/disclaimers.js
// ============================================

import React, { useEffect } from 'react';
import styles from './Legal.module.css';

// NOTE: Renamed component function to DisclaimersPageComponent for consistency.
const DisclaimersPageComponent = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
      }, []);
      ...
      return (
        <div className={styles['legal-page']}>
          <div className={styles['legal-hero']}>
            <div className={styles['legal-hero-content']}>
              <h1 className={styles['legal-title']}>Disclaimers</h1>
              <p className={styles['legal-subtitle']}>Important information about using our website and services.</p>
              <div className={styles['legal-updated']}>Last Updated: November 2025</div>
            </div>
          </div>
    
          <div className={styles['legal-container']}>
            <div className={styles['legal-intro']}>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>1. General Disclaimer</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>2. No Professional Advice</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>3. Product Information and Specifications</h2>
              ...
              <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>4. Pricing Disclaimer</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>5. Performance and Range Estimates</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>6. Third-Party Content and Links</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>7. Availability and Service</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>8. No Warranty</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>9. Limitation of Liability</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>10. Regional Variations</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>11. Calculator Tools Disclaimer</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>12. Changes to Disclaimer</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>13. Contact Us</h2>
              <p>If you have any questions about this disclaimer, please contact us:</p>
              <div className={styles['legal-contact-card']}>
                <h3 className={styles['contact-card-title']}>EVall Mobility Pvt. Ltd.</h3>
...
export default DisclaimersPageComponent;