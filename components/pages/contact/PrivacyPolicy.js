        ...
        <div className={styles['legal-page']}>
          <div className={styles['legal-hero']}>
            <div className={styles['legal-hero-content']}>
              ...
              <p className={styles['legal-subtitle']}>Your privacy matters to us. Learn how we protect your data.</p>
              <div className={styles['legal-updated']}>Effective Date: November 2025</div>
            </div>
          </div>
          ...
          <div className={styles['legal-container']}>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-t  itle']}>1. Information We Collect</h2>
              <p>We collect information to deliver a personalized and secure user experience. This includes:</p>
              
              <div className={styles['legal-subsection']}>
                <h3 className={styles['legal-subsection-title']}>a. Information You Provide Directly</h3>
              ...
              <div className={styles['legal-subsection']}>
                <h3 className={styles['legal-subsection-title']}>b. Information Collected Automatically</h3>
              ...
              <div className={styles['legal-subsection']}>
                <h3 className={styles['legal-subsection-title']}>c. Information from Third Parties</h3>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>2. How We Use Your Information</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>3. Information Sharing and Disclosure</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>4. Data Retention</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>5. Data Security</h2>
              ...
              <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>6. Your Rights</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>8. Children's Privacy</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>9. Policy Updates</h2>
            ...
            <section className={styles['legal-section']}>
              <h2 className={styles['legal-section-title']}>10. Contact Us</h2>
