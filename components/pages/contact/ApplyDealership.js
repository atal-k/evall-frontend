// ============================================
// /components/pages/contact/ApplyDealership.js
// ============================================
...
// NOTE: Renamed component function to ApplyDealershipPageComponent for consistency.
const ApplyDealershipPageComponent = () => {
  return (
    <div className="apply-dealership-page">
      ...
      />
      <section
        className="apply-dealership-section"
        aria-labelledby="apply-dealership-heading"
      >
...
export default ApplyDealershipPageComponent;
