...
// CHANGES: Minor adjustments for responsive optimization
// ============================================================================
...
const DealerCard = ({ dealer, index }) => {
  ...
  return (
    <div className={`${styles['dealer-card']} ${isVisible ? styles['dealer-card--visible'] : ''}`}>
      ...
      <div className={styles['dealer-info']}>
        <div className={styles['dealer-info-item']}>
          ...
          <div className={styles['dealer-info-text']}>
      ...
      <div className={styles['dealer-hero']}>
        <div className={styles['dealer-hero-content']}>
          ...
          <div className={styles['dealer-search-bar']}>
            ...
            {searchTerm && (
              <button 
                className={styles['dealer-search-clear']} 
