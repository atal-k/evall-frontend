// ============================================
// components/pages/tech/VehicleIntelligence.js
// ============================================
...
// NOTE: Renamed component function to VehicleIntelligencePageComponent for consistency.
const VehicleIntelligencePageComponent = () => {
  return (
    <div className="vehicle-intelligence-page">
      ...
      {/* Intelligent Capabilities section */}
...
export default VehicleIntelligencePageComponent;