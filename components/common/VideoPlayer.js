...
const VideoPlayer = ({ 
  ...
  return (
    ...
    >
      ...
      {/* Controls Footer */}
      <div className={`${styles['video-player__controls']} ${showControls || showControlsAlways ? styles['video-player__controls--visible'] : ''}`}>
        {/* Video Title */}
        <div className={styles['video-player__title']}>{title}</div>

        {/* Progress Bar */}
        <div className={styles['video-player__progress-container']} onClick={handleProgressClick}>
          <div className={styles['video-player__progress-bar']}>
            <div 
              className={styles['video-player__progress-fill']} 
...
*/}
        ...
        <div className={styles['video-player__buttons']}>
          <div className={styles['video-player__buttons-left']}>
            {/* Play/Pause */}
            <button className={styles['video-player__btn']} onClick={togglePlay} aria-label={isPlaying ? 'Pause' : 'Play'}>
              {isPlaying ? (
            ...
            {/* Skip Backward */}
            <button className={styles['video-player__btn']} onClick={skipBackward} aria-label="Skip backward">
            ...
            {/* Skip Forward */}
            <button className={styles['video-player__btn']} onClick={skipForward} aria-label="Skip forward">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          ...
          <div className={styles['video-player__buttons-right']}>
            {/* Volume */}
            <button className={styles['video-player__btn']} onClick={toggleMute} aria-label={isMuted ? 'Unmute' : 'Mute'}>
              {isMuted? (
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
