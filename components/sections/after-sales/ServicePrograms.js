// ============================================================================
// FILE: components/sections/ServicePrograms.js
// ============================================================================
...
const ServicePrograms = () => {
  ...
  return (
    <section className={styles['service-programs']}>
      <div className={styles['service-programs__container']}>
        <div className={styles['service-programs__header']}>
          <h2 className={styles['service-programs__tagline']}>EVall Mobility: Aapka Bharosa Hamara Waada</h2>
          <h3 className={styles['service-programs__title']}>After Sales Services</h3>
        </div>
  
        <div className={styles['service-programs__content']}>
          <p className={styles['service-programs__description']}>
        ...
        <div className={styles['service-programs__list']}>
          {services.map((service, index) => (
            <div key={index} className={styles['service-programs__item']}>
              <div className={styles['service-programs__item-icon']}>
              ...
              <span className={styles['service-programs__item-text']}>{service}</span>
            </div>
          ))}
        </div>
      </div>
