// filepath: components/sections/ContactSection.js
...
const ContactSection = () => {
  return (
    <section className={styles['contact-section']} aria-labelledby="contact-heading">
      <div className={styles['contact-section__wrapper']}>
        <aside className={styles['contact-section__left']}>
          <div className={styles['contact-section__left-content']}>
            <h2 id="contact-heading" className={styles['contact-section__heading']}>
              How can we help you
            </h2>
            ...
            <h3 className={styles['contact-section__subheading']}>Registered Office:</h3>

            <div className={styles['contact-section__info-block']}>
              <div className={styles['contact-section__icon-tile']} aria-hidden="true">
              ...
              <div className={styles['contact-section__info-text']}>
                <p className={styles['contact-section__address']}>
            ...
            <div className={styles['contact-section__info-block']}>
              ...
              <div className={styles['contact-section__info-text']}>
                <p className={styles['contact-section__contact-line']}>Phone: (0172) 450 9386</p>
              </div>
            </div>
            ...
            <div className={styles['contact-section__info-block']}>
              ...
              <div className={styles['contact-section__info-text']}>
                <p className={styles['contact-section__contact-line']}>Email: info@evall.co.in</p>
              </div>
            </div>
          </div>
        </aside>

        <main className={styles['contact-section__right']}>
