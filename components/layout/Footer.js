          ...
          <div className={styles['footer__main']}>
            ...
            <div className={styles['footer__logo']}>
              ...
              <div className={styles['footer__certifications']}>
                <h4 className={styles['footer__cert-title']}>Certifications & Partners</h4>
                <div className={styles['footer__cert-icons']}>
                  <div className={styles['footer__cert-icon']}>
            ...
            <div className={styles['footer__section']}>
              <h4 className={styles['footer__section-title']}>Quick Links</h4>
              <div className={styles['footer__links']}>
                <Link href="/" className={styles['footer__link']}>Home</Link>
                <Link href="/about-us" className={styles['footer__link']}>About Us</Link>
                <Link href="/vehicle-showcase" className={styles['footer__link']}>Products</Link>
                <Link href="#" className={styles['footer__link']}>Technology</Link>
                <Link href="#" className={styles['footer__link']}>Services</Link>
                <Link href="#" className={styles['footer__link']}>Resources</Link>
                <Link href="/contact-us" className={styles['footer__link']}>Contact</Link>
              </div>
            </div>
            
            {/* Contact Information Section */}
            <div className={styles['footer__section']}>
              <h4 className={styles['footer__section-title']}>Contact Information</h4>
            ...
            {/* Newsletter Section */}
            <div className={styles['footer__section']}>
              <h4 className={styles['footer__section-title']}>Stay updated</h4>
              ...
              <div className={styles['footer__newsletter-input-wrapper']}>
                <input 
                  ...
                  required
                />
                <div className={styles['footer__newsletter-input-icon']}>
                  {getIcon('email', 24)}
                </div>
              </div>
